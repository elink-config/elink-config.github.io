...
Webtool hợp nhất cho các thiết bị E-Ink dùng chip DA14585, gộp ba tool:
...
trong `js/4_2/`, `js/2_13/` hoặc `js/dlg/`, rồi bàn giao thiết bị đã chọn cho
...
- `index.html` — khung kết nối + 3 template giao diện
- `js/connector.js` — hub: quét BLE, nhận dạng, nạp app, bàn giao kết nối
- `js/dithering.js`, `js/paint.js`, `js/crop.js` — pipeline ảnh dùng chung cho 2 tool DIY
...
- `?debug=true&app=4_2|2_13|dlg` — xem trước giao diện một app mà không cần thiết bị
