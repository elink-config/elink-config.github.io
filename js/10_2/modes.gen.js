...
window.EPD_MODES = [
  ...
  { mode: 13, name: 'Lịch dương + âm', tick: 'Làm mới mỗi phút', id: 'countdownmodebutton', draw: 'm14' },
  ...
  { mode: 18, name: 'Hoàng hôn 8-bit', tick: 'Làm mới mỗi phút', id: 'retrosunsetmodebutton', draw: 'm22' },
  { mode: 19, name: 'Khủng long 8-bit', tick: 'Cập nhật lúc 0h', id: 'retrowinmodebutton', draw: 'm23' },
  { mode: 20, name: 'Thành phố 8-bit', tick: 'Làm mới mỗi phút', id: 'retrocitymodebutton', draw: 'm24' },
  { mode: 21, name: 'Tự thiết kế', tick: 'Làm mới mỗi phút', id: 'custommodebutton', draw: 'm20' },
];
